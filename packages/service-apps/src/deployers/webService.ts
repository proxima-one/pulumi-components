...
export class WebServiceDeployer extends AppDeployerBase {
  public deploy(app: WebService): DeployedServiceApp {
    const webServiceDeployer = new k8sServices.deployers.WebServiceDeployer(
...
export interface WebService extends k8sServices.deployers.WebService {}

export interface DeployedServiceApp
  extends k8sServices.deployers.DeployedServiceApp {}
